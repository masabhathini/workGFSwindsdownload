...
opendap_url = 'http://nomads.ncep.noaa.gov/dods/gfs_0p25_1hr/gfs' + startdatestamp + '/gfs_0p25_1hr_' + cycle + 'z'
...
ugrd10m = ds['ugrd10m'].sel(time=pd.date_range(start=startdate, end=enddatestamp, freq='1h'))
vgrd10m = ds['vgrd10m'].sel(time=pd.date_range(start=startdate, end=enddatestamp, freq='1h'))
...
outputfile = outputpath + 'gfsforecast/' + startdatestamp + cycle + '/gfs' + startdatestamp + cycle + '_1hr.nc'
